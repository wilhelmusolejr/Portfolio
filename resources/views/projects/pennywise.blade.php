@php
    $project_path = "img/Projects/Info/pennywise/";
@endphp
...
<x-project.layout :projectPath="$project_path">
    ...
    <div class="text-center mb-5">
        <img class="rounded" src="{{ asset($project_path.'banner.png') }}" alt="PennyWISE PH Banner">
    </div>
    ...
    <x-project.section>
        ...
        <div class="d-flex flex-column gap-3 text-light">
            <div class="text-center my-3">
                <img src="{{ asset($project_path.'screenshot1.png') }}" alt="PennyWISE PH Screenshot 1">
            </div>
            <div class="text-center my-3">
                <img src="{{ asset($project_path.'screenshot2.png') }}" alt="PennyWISE PH Screenshot 2">
            </div>
        </div>
    </x-project.section>
